...
export default function Home({jobs}) {
  ...
  return (
    <div>
      ...
      <Link href="/jobs"><button className=" ml-2 mt-4 md:ml-28 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-babypowder bg-babypowder transition duration-150 ease-in-out hover:bg-primary hover:text-white lg:text-lg lg:font-bold  rounded-full text-black px-4 sm:px-10  py-2 sm:py-4 text-lg font-semibold">
