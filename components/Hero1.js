            ...
            <div className="items-center lg:flex">
                <div className="w-full lg:w-1/2">
                    <div className="lg:max-w-lg">
                        ...
                        <button className=" mt-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-babypowder bg-primary transition duration-150 ease-in-out hover:bg-babypowder hover:text-black lg:text-lg lg:font-bold  rounded-full text-white px-4 sm:px-10  py-2 sm:py-4 text-sm">Find Gigs</button>
                        <button className="ml-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-babypowder transition duration-150 ease-in-out hover:bg-primary hover:text-neutral  lg:text-lg lg:font-bold  rounded-full text-black px-4 sm:px-10  py-2 sm:py-4 text-sm">Post a Gig</button>
                    </div>
                </div>
