            ...
            <div className="items-center lg:flex">
                <div className="w-full lg:w-1/2">
                    <div className="lg:max-w-lg">
                        ...
                        <a href="#middle"><button className=" mt-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-babypowder bg-primary transition duration-150 ease-in-out hover:bg-babypowder hover:text-black lg:text-lg lg:font-bold  rounded-full text-white px-4 sm:px-10  py-2 sm:py-4 text-base font-semibold">Find Gigs</button></a>  
                       <Link href="/jobs/pricing"><button className="ml-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-babypowder transition duration-150 ease-in-out hover:bg-primary hover:text-neutral  lg:text-lg lg:font-bold  rounded-full text-black px-4 sm:px-10  py-2 sm:py-4 text-base font-semibold">Post a Gig</button></Link>
                    </div>
                </div>
                ...
                <div className=" w-full  mt-2 px-0">
                     <div className="container m-auto px-6 flex items-end justify-start md:px-12 lg:px-7">
                      <div className="  space-x-4 inline-flex md:flex md:items-start ">
