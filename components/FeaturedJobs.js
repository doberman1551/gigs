...
const FeaturedJobs = ({job}) => {
  ...
  return (
  <div className={`rounded-xl ${job.attributes.featured===true? ' bg-gradient-to-r p-[6px] from-[#6EE7B7] via-[#3B82F6] to-[#9333EA] h-[150px] md:w-full md:h-[100px]  md:my-4':'bg-graybg h-24 md:w-full md:h-24 md:my-6'} my-16 md:my-4   flex justify-center items-center`}>
  ...
  <div  className=" w-full flex justify-items-start space-x-4 relative cursor-pointer">
    <Image className="rounded-xl"
      ...
      <div class="w-full">
                        ...
                        <p tabindex="0" class="focus:outline-none text-base  text-white mt-3 md:mt-5"> </p>
                        </div>
