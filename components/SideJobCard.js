...
const SideJobCard = () => {
  ...
  <div className="relative p-1 pb-8 rounded-xl group w-80% sm:h-96 sm:w-96 bg-graybg bg-opacity-50 shadow-xl hover:rounded-2xl my-16 md:my-0">
          ...
          <a href="#" className=" inset-x-4 bottom-4 flex items-center space-x-2 py-2">
            <div aria-hidden="true" className="h-10 w-10 flex border border-neutral-200 rounded-full">
