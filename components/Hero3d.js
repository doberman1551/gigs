            ...
            <div className="items-center lg:flex">
                <div className="w-full lg:w-1/2">
                    <div className="lg:max-w-lg">
                        ...
                        <a href="#middle"><button className=" mt-8 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-babypowder bg-primary transition duration-150 ease-in-out hover:bg-babypowder hover:text-black lg:text-lg lg:font-bold  rounded-full text-white px-4 sm:px-10  py-2 sm:py-4 text-sm">Find Gigs</button></a>  
                ...
                <div className="flex items-center justify-center w-full  mt-0 lg:mt-0 lg:w-1/2 ">
                <Spline scene="https://prod.spline.design/CJCaBJpWeN2QYHw5/scene.splinecode"   className="pt-2 md:pt-0 " />
                </div>
